...
namespace TabloidCLI
{
    public class PostRepository : DatabaseConnector, IRepository<Post>
    {
        ...
        {
            //Getall below was added to original code 
            using (SqlConnection conn = Connection)
            {
                conn.Open();
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    cmd.CommandText = @"SELECT p.Id, p.Title, p.Url, p.PublishDateTime, p.BlogId, p.AuthorId 
                    FROM Post p
    ...
    using (SqlConnection conn = Connection)
    {
        ...
        //below there was no code initially
